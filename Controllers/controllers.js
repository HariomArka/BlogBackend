...
const createBlog = async(req,res)=>{
    ...
    try{
        const Blog = await blog.create({title,image,choice,description,author,username})
...
module.exports = {getBlogs,getoneBlog,createBlog,deleteBlog,updateBlog,updateBlogLikes,addBlogComment,getmyBlogs}